"""
Track props modelled in Blender and exported to public/gfx/models/props.glb, plus the foliage
texture atlas (public/gfx/tex/foliage.webp) rendered from scattered leaf and needle meshes.
...
from mesh import TAU, Builder  # noqa: E402
